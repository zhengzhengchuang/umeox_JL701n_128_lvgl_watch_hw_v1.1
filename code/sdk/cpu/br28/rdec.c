...
static RDEC_REG rdec_save[3];

AT_VOLATILE_RAM_CODE_POWER
static void rdec_enter_deepsleep(void)
{
    rdec_save[0].con = JL_RDEC0->CON;
    rdec_save[0].dat = JL_RDEC0->DAT;
    rdec_save[0].smp = JL_RDEC0->SMP;
    rdec_save[1].con = JL_RDEC1->CON;
    rdec_save[1].dat = JL_RDEC1->DAT;
    rdec_save[1].smp = JL_RDEC1->SMP;
    rdec_save[2].con = JL_RDEC2->CON;
    rdec_save[2].dat = JL_RDEC2->DAT;
    rdec_save[2].smp = JL_RDEC2->SMP;
}

AT_VOLATILE_RAM_CODE_POWER
static void rdec_exit_deepsleep(void)
{
    JL_RDEC0->CON = rdec_save[0].con;
    JL_RDEC0->DAT = rdec_save[0].dat;
    JL_RDEC0->SMP = rdec_save[0].smp;
    JL_RDEC1->CON = rdec_save[1].con;
    JL_RDEC1->DAT = rdec_save[1].dat;
    JL_RDEC1->SMP = rdec_save[1].smp;
    JL_RDEC2->CON = rdec_save[2].con;
    JL_RDEC2->DAT = rdec_save[2].dat;
    JL_RDEC2->SMP = rdec_save[2].smp;
}
