...
#include "app_config.h"
    ...
    extern void lv_draw_jl_dma2d_ctx_init(lv_disp_drv_t * drv, lv_draw_ctx_t * draw_ctx);
    extern void lv_draw_jl_dma2d_ctx_deinit(lv_disp_drv_t * drv, lv_draw_ctx_t * draw_ctx);
    typedef lv_draw_sw_ctx_t lv_draw_jl_dma2d_ctx_t;
    driver->draw_ctx_init = lv_draw_jl_dma2d_ctx_init;
    driver->draw_ctx_deinit = lv_draw_jl_dma2d_ctx_init;
    driver->draw_ctx_size = sizeof(lv_draw_jl_dma2d_ctx_t);
