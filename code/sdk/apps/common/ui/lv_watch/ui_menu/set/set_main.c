...
static void title_label_create(menu_align_t menu_align)
{
    ...
    widget_label_para.label_text = get_lang_txt_with_id(lang_txtid_settings);
...
static void elem_ctx_icon_create(menu_align_t menu_align)
{
    ...
    for(uint8_t idx = 0; idx < Elem_Num; idx++)
    {
        ...
        widget_img_para.file_img_dat = settings_00_index + idx;
        lv_obj_t *elem_ctx_icon = common_widget_img_create(&widget_img_para, NULL);
...
static void elem_ctx_label_create(menu_align_t menu_align)
{
    ...
    for(uint8_t idx = 0; idx < Elem_Num; idx++)
    {
        ...
        widget_label_para.label_text = get_lang_txt_with_id(txt_id[idx]);
...
static void elem_ctx_arrow_create(menu_align_t menu_align)
{
    ...
    {
        widget_img_para.img_parent = elem_container[idx];
        lv_obj_t *elem_ctx_arrow = common_widget_img_create(&widget_img_para, NULL);
