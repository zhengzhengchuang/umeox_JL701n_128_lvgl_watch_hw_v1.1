...
static void menu_display_cb(lv_obj_t *obj)
{
    ...
    widget_img_para.file_img_dat = kaaba_01_index;
    ...
    widget_label_para.label_parent = kaaba_qibla_container;
    widget_label_para.label_text = YawNumStr;
    kaaba_yaw_label = common_widget_label_create(&widget_label_para);
