...
static void menu_refresh_cb(lv_obj_t *obj)
{
    ...
    if(cali_succ == true)
    {
        if(ll_info.position_valid == false)
        {
            DisableFlag = 1;
...
static void menu_display_cb(lv_obj_t *obj)
{
    ...
    lv_obj_align(mag_calibra_tips_label, LV_ALIGN_TOP_MID, 0, 292);
