...
static void menu_display_cb(lv_obj_t *obj)
{
    ...
    widget_label_para.label_text = get_lang_txt_with_id(lang_txtid_call_disc_tips);
    lv_obj_t *tips_label = common_widget_label_create(&widget_label_para);
    lv_obj_align(tips_label, LV_ALIGN_TOP_MID, 0, 68);
