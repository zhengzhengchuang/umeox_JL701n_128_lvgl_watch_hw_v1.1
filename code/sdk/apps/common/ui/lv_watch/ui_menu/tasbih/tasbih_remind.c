...
static void menu_display_cb(lv_obj_t *obj)
{
    ...
    widget_img_para.file_img_dat = tasbih_icon_03_index;
    widget_img_para.img_click_attr = false;
    widget_img_para.event_cb = NULL;
    lv_obj_t *tasbih_remind_icon = common_widget_img_create(&widget_img_para, NULL);
    lv_obj_align(tasbih_remind_icon, LV_ALIGN_TOP_MID, 0, 112);
    ...
    widget_label_para.label_text = get_lang_txt_with_id(lang_txtid_tasbih_time);
    lv_obj_t *tasbih_remind_label = common_widget_label_create(&widget_label_para);
    lv_obj_align(tasbih_remind_label, LV_ALIGN_TOP_MID, 0, 332);
