...
static void tasbih_stime_confirm_cb(lv_event_t *e)
{
    ...
    ui_menu_jump(ui_act_id_tasbih_end_time);
...
static void menu_create_cb(lv_obj_t *obj)
{
    ...
    tasbih_stime_hour = TasbihR_STimestamp/3600;
    tasbih_stime_minute = (TasbihR_STimestamp%3600)/60;
...
static void menu_display_cb(lv_obj_t *obj)
{
    ...
    widget_label_para.label_text = get_lang_txt_with_id(lang_txtid_start_time);
    lv_obj_t *tasbih_stime_label = common_widget_label_create(&widget_label_para);
    lv_obj_align(tasbih_stime_label, LV_ALIGN_TOP_MID, 0, 40);

    widget_img_para.img_parent = obj;
    widget_img_para.file_img_dat = comm_icon_37_index;
    widget_img_para.img_click_attr = false;
    widget_img_para.event_cb = NULL;
    tasbih_stime_hour_sel = common_widget_img_create(&widget_img_para, \
        &tasbih_stime_hour_dsc);
    lv_obj_align(tasbih_stime_hour_sel, LV_ALIGN_LEFT_MID, 32, 11);

    widget_img_para.file_img_dat = comm_num_30x50_wh_10_index;
    lv_obj_t *tasbih_stime_colon = common_widget_img_create(&widget_img_para, NULL);
    lv_obj_align(tasbih_stime_colon, LV_ALIGN_LEFT_MID, 176, 10);

    widget_img_para.file_img_dat = comm_icon_38_index;
    tasbih_stime_minute_sel = common_widget_img_create(&widget_img_para, &tasbih_stime_minute_dsc);
    lv_obj_align(tasbih_stime_minute_sel, LV_ALIGN_LEFT_MID, 216, 11);
    ...
    widget_roller_para.roller_sel = tasbih_stime_hour;
    ...
    tasbih_stime_hour_roller = common_widget_roller_create(&widget_roller_para);
    lv_obj_align(tasbih_stime_hour_roller, LV_ALIGN_LEFT_MID, 32, 10);
    lv_obj_add_event_cb(tasbih_stime_hour_roller, tasbih_stime_hour_roller_cb, LV_EVENT_ALL, NULL);
    

    widget_roller_para.roller_options = time_min_sec_str;
    widget_roller_para.roller_sel = tasbih_stime_minute;
    ...
    widget_roller_para.event_cb = NULL;
    widget_roller_para.user_data = NULL;
    tasbih_stime_minute_roller = common_widget_roller_create(&widget_roller_para);
    lv_obj_align(tasbih_stime_minute_roller, LV_ALIGN_LEFT_MID, 216, 10);
    lv_obj_add_event_cb(tasbih_stime_minute_roller, tasbih_stime_minute_roller_cb, LV_EVENT_ALL, NULL);

    widget_img_para.img_parent = obj;
    widget_img_para.file_img_dat = comm_icon_02_index;
    widget_img_para.img_click_attr = true;
    widget_img_para.event_cb = tasbih_stime_confirm_cb;
