...
static void menu_display_cb(lv_obj_t *obj)
{
    ...
    widget_img_para.file_img_dat = \
        watchface_03_bg_index;
    widget_img_para.img_click_attr = false;
    widget_img_para.event_cb = NULL;
    common_widget_img_create(&widget_img_para, NULL);

    widget_time_para.time_x = 209;
    widget_time_para.time_y = 60;
    ...
    widget_time_para.time_y = 162;
    common_time_widget_create(\
        &widget_time_para, widget_time_mode_mm);

    lang_id_t lang_id = \
        get_comm_sys_language();
    comm_week_para.week_x = 208;
    comm_week_para.week_y = 252;
    ...
    widget_date_para.date_x = 226;
    widget_date_para.date_y = 296;
