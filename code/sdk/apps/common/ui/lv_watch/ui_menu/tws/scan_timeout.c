...
static void scan_again_cb(lv_event_t *e)
{
    if(!e) return;
...
static void menu_create_cb(lv_obj_t *obj)
{
    ...
    if(!lang_txt_is_arabic())
        tileview_register_all_menu(obj, ui_act_id_null, ui_act_id_null, \
            prev_act_id, ui_act_id_null, ui_act_id_scan_timeout);
    else
        tileview_register_all_menu(obj, ui_act_id_null, ui_act_id_null, \
            ui_act_id_null, prev_act_id, ui_act_id_scan_timeout);
...
static void menu_display_cb(lv_obj_t *obj)
{
    ...
    widget_label_para.label_text = get_lang_txt_with_id(lang_txtid_not_found_tws);
    ...
    widget_img_para.event_cb = scan_again_cb;
    widget_img_para.user_data = NULL;
    lv_obj_t *_again_button = common_widget_img_create(&widget_img_para, NULL);
    lv_obj_align(_again_button, LV_ALIGN_TOP_MID, 0, 376);
    lv_obj_set_ext_click_area(_again_button, 20);
