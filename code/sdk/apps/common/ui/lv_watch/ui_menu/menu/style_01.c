...
{
    widget_label_para.label_w = ec_w - 10;
...
static void pressing_cb(lv_event_t *e)
{
    ...
    }else
    {
        ...
        int16_t scroll_bottom_val = (-1)*(((Elem_Num+1)/2) - visual_line)*ec_h;
...
static void release_cb(lv_event_t *e, int *state)
{
    ...
    lv_anim_set_ready_cb(widget_anim_para.anim, throw_anim_ready_cb);
