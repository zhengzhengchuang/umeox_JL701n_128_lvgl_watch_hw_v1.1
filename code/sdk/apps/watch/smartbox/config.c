...
void smartbox_config(struct smartbox *smart)
{
    ...
    smart->extra_flash_en = JL_SMART_BOX_EXTRA_FLASH_OPT;
#endif

#if (WATCH_FILE_TO_FLASH && TCFG_DEV_MANAGER_ENABLE)
    smart->file_trans_back_mode = 1;
    smart->file_transfer_mode = 1;
#if (TCFG_NOR_FAT)
    smart->file_trans_nor_fat = 1;
#endif
#endif

#if JL_SMART_BOX_SIMPLE_TRANSFER
    smart->file_simple_trans_mode = 1;
#endif
